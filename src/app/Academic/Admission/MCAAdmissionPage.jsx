            ...
            <div className="admission-info">
              ...
              <div className="requirements-container">
                <div className="requirement">
                  ...
                  <ul>
                    <li className="pt-3">
                      Candidates must have a Bachelor's degree in any discipline with Mathematics at 10+2 level or at graduation level.
                    </li>
                  </ul>
                </div>
...
export default MCAAdmissionPage;
