...
const CalenderTable = () => {
  const dataOdd = [
    {
      link: "https://drive.google.com/file/d/1DGBVauEQaQ1zC6iryZ41-nIPv6Gvx9em/view?usp=sharing",
      para: " Academic Calendar for Even(Spring) Semester, Academic Session 2024-25 ",
    },
    {
      link: "https://drive.google.com/file/d/1tVgQSygS8GRTZIglbVWVClasegdd6BCi/view",
      para: "Academic Calendar for Odd(Autumn) Semester, Academic Session 2024-25 ",
    },
  ];
