...
const Allhostels = [
  ...
  {
    name: "Dr. Sanchari Basu",
    designation: "Asst. Warden",
    mobile: "9051324925",
    email: "sanchari.ch@nitp.ac.in",
  },
  {
    name: "Anupma Kumari",
  ...
  {
    name: "Dr Vikash Kumar Raj",
    designation: "Sr. Medical Officer",
    mobile: "9471003542",
    email: "smo@nitp.ac.in",
  },
],
  },
  {
          ...
          <tbody>
            {HMCOfficeContacts.length > 0 ? (
              HMCOfficeContacts.map((contact, index) => (
                <tr
                  key={index}
                  className={`border-b text-sm md:text-base border-gray-100 hover:bg-red-50 transition-colors ${index % 2 === 0 ? "bg-white" : "bg-gray-50"
                    }`}
                >
