      ...
      <div className="flex-1 flex flex-col items-center px-2">
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-lg p-6 md:p-10">
          <h1 className="text-3xl font-extrabold text-red-700 text-center mb-8 tracking-tight">
            Doctor's Weekly Schedule (Bihta Campus)
          </h1>
          ...
          <ul className="mt-8 bg-red-50 rounded-xl p-5 text-gray-800 text-base shadow-inner">
            <li className="mb-2">
              <span className="font-semibold text-red-700">Counsellor (Mr. Tinku Kumar):</span> Monday to Thursday; and Saturday to Sunday from <b>05:00 PM to 08:00 PM</b>.
            </li>
            <li className="mt-2 text-sm text-gray-600">
              <b>Note:</b> All the above mentioned Medical Officer and Counsellor will ensure that they should be available 24x7 through electronic mode.
            </li>
          </ul>
        </div>
      </div>
