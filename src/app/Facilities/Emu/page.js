  ...
  const places = [
    {
      ...
      text: `To provide Electric power supply to the Institute. EMU maintains all electrical equipment such as Lights, Fans, AC, etc. which are installed in NIT Patna campus. 
      EMU is having an 11KV/415V Electrical Substation (commonly Known as POWER HOUSE), equipped with 02 Nos. 1250KVA Transformer, 02 Nos. 750 KVA Diesel Generator and 
      Separate Electricals Panels for each feeder pillars/Buildings`,
      ComplaintForm: <a href="https://drive.google.com/drive/folders/1DJjrqjQVvjGdRnU1Hd1sJpqmJM7WGAZe" target="_blank" rel="noopener noreferrer" className="text-black  hover:text-red-800">Click here</a>
              ...
              <>
                <div className="md:pl-4">
                  ...
                  <p className="mt-4 text-gray-600">
                    <strong>Landline:</strong> {place.landline} <br />
