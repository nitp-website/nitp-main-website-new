        ...
        <div className="w-full px-5 xs:px-0 md:w-[90%] mx-auto">
          ...
          <ul className="list-disc pl-5 space-y-2 text-justify mt-2 text-black">
            ...
            <li>
              ...
              documentation, make effective presentations, and receive clear
              instructions.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-2 text-justify mt-2 text-black">
            <li>
              To prepare graduates in Applied Physics and Materials Engineering
              for successful careers in Industry, Research, Entrepreneur and
              Academics dealing with analysis, design and management of systems
              and processes. It must also enable them to develop a strong
              understanding of various aspects of Materials Science and
              Engineering.
            </li>
            <li>
