    ...
    return (
        <div className="container mx-auto mt-3 bg-red-100  w-[70%] rounded-xl pt-4">
            <div className="container mx-auto px-4  bg-red-100 text-black w-full md:w-[70%]">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center">
                        <p className="text-xs sm:text-base ">B.Tech ECE :</p>
                    </div>
            ...
            <div className="container mx-auto px-4  bg-red-100 text-black w-full md:w-[70%]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center">
                        <p className="text-xs sm:text-base "> Dual Degree :</p>
                    </div>
                    <div className="flex justify-end">
            ...
            <div className="container mx-auto px-4  bg-red-100 text-black w-full md:w-[70%]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center">
                        <p className="font-medium text-xs sm:text-base ">Minor Courses :</p>
                    </div>
                    <div className="flex justify-end">
            ...
            <div className="container mx-auto px-4  bg-red-100 text-black w-full md:w-[70%]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center">
                        <p className="font-medium text-xs sm:text-base whitespace-nowrap">M.Tech Next Generation Wireless Technologies:</p>
                    </div>
                    <div className="flex justify-end">
            ...
            <div className="container mx-auto px-4  bg-red-100 text-black w-full md:w-[70%] py-2">
              
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center">
                        <p className="font-medium text-xs sm:text-base whitespace-nowrap">M.Tech Microelectronics & VLSI System Design:</p>
                    </div>
                    <div className="flex justify-end">
