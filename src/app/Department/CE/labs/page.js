    ...
    return (
        <div className="mb-10">
                <div className=" grid grid-cols-2 max-md:grid-cols-1">
                    ...
                    <div className=" flex justify-center">
                        <div className="flex flex-col">
                            <Image src={image} width={700} height={1000} alt="Loading.." className="col-span-1 h-80 border rounded-lg bg-rose-200" />
                        </div>
                    </div>
                </div>
        </div>
