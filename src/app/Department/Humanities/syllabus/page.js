...
const syllabusdata = [
    {
        srno: 1,
        title: "Syllabus for UGPG Students",
        url: "https://drive.google.com/file/d/1a2b3c4d5e6f7g8h9i0j/view?usp=sharing" // replace with actual link
    },
    {
        srno: 2,
        title: "Syllabus for PhD Students",
        url: "https://drive.google.com/file/d/1a2b3c4d5e6f7g8h9i0j/view?usp=sharing" // replace with actual link
    }
]
                            ...
                            <table className="md:w-[90%] overflow-hidden rounded-lg mx-auto border-collapse bg-white">
                                <thead>
                                    <tr className="bg-[#421010] text-white">
                                        <th className="text-center px-6 py-4 font-semibold w-20">Sr No.</th>
                                ...
                                <tbody>
                                    {syllabusdata.length > 0 ? (
                                        syllabusdata.map((item, index) => (
                                            ...
                                            >
                                                <td className="text-center px-6 py-4 text-gray-800 font-medium">{item.srno}</td>
