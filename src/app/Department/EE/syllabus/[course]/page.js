...
const BTechSyllabus = () => {
    const courses = [
             {
            course: "B.Tech Course Structure (2025-26) Onwords",
            link: "https://drive.google.com/file/d/1iFYu-J-MLP9EmCDdgN_gm8fsxAAtBtAP/view?usp=sharing",
        },
        {
            course: "B.Tech Course Structure (2023-24) Onwords",
            link: "https://drive.google.com/file/d/1Cu_x0ggRYgwnEGXPknbq6uMPtPN0lWlw/view?usp=sharing",
        },
...
const MTechPowerDSSyllabus = () => {
    const courses = [
           ...
           {
            course: "Dual Degree (B.Tech + M.Tech (PSE)) Course Structure (2024-25) to (2028-29)",
            link: "https://drive.google.com/file/d/16mlYmjGzGof9NBCbQN4C1fCEcd-_1tjB/view?usp=sharing",
        },

           {
            course: "Dual Degree (B.Tech + M.Tech (PSE)) Course Structure (2023-24) to (2027-28)",
            link: "https://drive.google.com/file/d/1o-HkQVw3RZlVW4euBfakVjemkZrluD-y/view?usp=sharing",
        },

           {
            course: "Dual Degree (B.Tech + M.Tech (PSE)) Course Structure (2022-23)-(2026-27)",
            link: "https://drive.google.com/file/d/15i603mFFd9cClN0my-i_5-C0EHEucjxp/view?usp=sharing",
        },
        ...
        // },
        {
            course: "Dual Degree (B.Tech + M.Tech (PSE)) Syllabus (2023-24) to (2027-28) ",
        ...
        // },
        {
            course: "Dual Degree (B.Tech + M.Tech (PSE)) Syllabus  (2022-23)-(2026-27)",
