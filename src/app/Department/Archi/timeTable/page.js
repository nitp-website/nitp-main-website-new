...
function Page() {
    const data = [
        {
            name: "Architecture Dept Time Table for the Class Jan- June 2025 (Even Semster)",
            link: "https://drive.google.com/file/d/1dTrFuT7-C5bkOUBDXwVhfdCCBZ35WAnG/view?usp=sharing"
        },
    ];
    return (
