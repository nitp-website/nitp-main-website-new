    ...
    <div className="bg-white text-black">
      <div className="py-1 mt-2">
        <div className="w-full px-5 xs:px-0 md:w-[90%] mx-auto">
          ...
          <ul className="list-disc pl-5 space-y-2 text-justify mt-2 text-black">
            <li>
              Graduates will have good fundamental and multidisciplinary
              knowledge with an ability to analyse, design, innovate and handle
              the realistic problems.
            </li>
            <li>
              Graduates will have a strong foundation in academics, leadership
              qualities and lifelong learning for a prosperous professional
              career.
            </li>
            <li>
              Graduates will have excellent communication skills, ethical
              conduct, sens
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-2 text-justify mt-2 text-black">
            <li>
              Ability to apply technology principles to design, develop and
              implement a suitable manufacturing process to meet the volatile
              needs of the industry and society at large.
            </li>
            <li>
              Ability to build the nation, by imparting technological inputs and
              managerial skills to become Technocrats and Entrepreneurs, build
              the attitude of developing new concepts on emerging fields and
