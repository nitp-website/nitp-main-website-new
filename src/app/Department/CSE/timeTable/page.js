...
function Page() {
    const data = [
        {
            name: "CSE Dept Time Table for the Class Jan- June 2025 (Even Semster)",
            link: "https://www.dropbox.com/scl/fo/ddgsmaaty167pa4632cv5/AMY3JIuaJNZ5PDZRoMWvPkE?rlkey=361szxfzpb1ms1kk21ntj9oxw&e=3&dl=0"
        },
    ];
    return (
