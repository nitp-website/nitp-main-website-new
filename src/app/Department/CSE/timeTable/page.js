    ...
    return (
        <div className=" flex flex-col p-5 h-screen text-black">  
            ...
            <div className="max-sm:mx-6 max-md:mx-8 mx-20 border p-4 rounded-md shadow-lg shadow-slate-400 backdrop-blur-md h-screen">
                <div className='mt-14 '>
                    <a href={'https://www.dropbox.com/scl/fo/ddgsmaaty167pa4632cv5/AMY3JIuaJNZ5PDZRoMWvPkE?rlkey=361szxfzpb1ms1kk21ntj9oxw&e=2&dl=0'} className='lg:text-lg text-gray-500 font-semibold border-b-2 border-black hover:text-blue-500' target="_blank">
