...
export const AcadProgramCard = ({ program }) => {
  return (
    <div className="w-full md:w-[48%] bg-white border-2 border-red-800 rounded-xl shadow transition-shadow p-6 flex flex-col justify-between mb-4 hover:shadow-lg shadow-gray-200">
      <div>
