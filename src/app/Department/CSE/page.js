...
export default function CSE() {
    ...
    return (
      <div className="p-10 max-sm:px-0  text-black bg-cover bg-center" style={{
      background: '#ffd6d6',
      background: 'linear-gradient(90deg,rgba(255, 242, 242, 1) 0%, rgba(255, 245, 227, 1) 50%, rgba(255, 240, 240, 1) 100%)'
      }}>
      {/* heading */}
