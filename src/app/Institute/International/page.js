              ...
              <div className="event-content pt-16">
                ...
                {activeEventSubsection === 'InternationalVisit' && (
                  <div>
                    ...
                    <div className="event-card mt-14">
                      <div className='flex'>
                      <img src="/visit27.jpg" alt="Visit to University Of Leicester, UK" className="event-image border-black border-2 mx-auto h-[50vh] w-auto" />
                      <img src="/visit28.jpg" alt="Visit to University Of Leicester, UK" className="event-image border-black border-2 mx-auto h-[50vh] w-auto" />
                      </div>
                      <div className="event-description mx-5 md:mx-40 mt-12">
