...
const RegistrarPage = () => {
  return (
    <div className="p-4 md:p-4 flex flex-col items-center justify-center h-auto">
      <h1 className="text-2xl text-center pt-5 pb-7 mb-2 md:pb-0  md:pt-10 text-red-900 font-bold">
      ...
      <div className="w-[80%] flex flex-col items-center p-2 ">
        <div className="flex flex-col gap-8 h-auto">
          <div className="flex flex-col">
            <div className="border shadow-xl w-full  p-3 text-md font-semibold text-black">
              ...
              <div className="flex flex-col mt-3">
                <h1 className="text-red-800 font-bold text-xl pb-2">Notification</h1>
                <ul className="list-disc cursor-pointer ml-2 md:text-sm text-xs">
              ...
              <div className="flex flex-col border-2 rounded-xl pl-4 mt-4 pb-2">
                <span className="text-red-800 text-xl font-bold mt-4">
                  Contact Details
                </span>
                <div className="flex flex-col mb-2 mt-4 md:text-sm text-xs">
                  <span className="text-md font-bold">Dr. Amit Kumar Singh</span>
