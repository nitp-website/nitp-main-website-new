...
const FacultyInfo = () => {
  ...
  useEffect(() => {
    fetch(uri)
      ...
      .then((data) => {
        ...
        let arr = data.publications
          ? JSON.parse(data.publications[0].publications)
          : [];
        console.log(arr);
  ...
  return (
    <div>
      ...
      curr_admin_responsibility.length > 0 ||
      past_admin_responsibility.length > 0 ? (
        <div className="flex flex-col md:flex-row">
          <Sidebar
            ...
            curr_admin={curr_admin_responsibility}
              ...
              <div className="w-full p-3 text-black">
                ...
                <div className="w-full p-3 text-black border rounded-md  flex justify-center items-center overflow-scroll h-[60vh] shadow-lg hover:shadow-2xl">
                  <button
                    onClick={() => {
                      resume
                        ? downloadFileURL(resume)
                        : alert("file not exist");
                    }}
                    className="w-[200px] p-3 text-black bg-[#941B0C] "
                  >
                    {" "}
                    Download CV
                  </button>
            ...
            {state === 5 && (
              <div className="w-full p-3 text-black ">
                ...
                {education ? (
                    ...
                    <table className="w-full">
                      <tbody>
                        <tr className="border  border-black ">
                          <td className="border-r px-3  border-black capitalize w-[100px] font-bold">
                            certification
                          </td>
                          <td className="border-r px-3 border-black capitalize w-[350px] font-bold">
                            institution
                          </td>
                        ...
                        {education.map((item) => {
                          return (
                            <tr className="border  border-black" key={item.id}>
                              <td className="border-r px-3  border-black capitalize w-[100px] -mr-40">
                                {item.certification ? item.certification : "-"}
                              </td>
                              <td className="border-r px-3 border-black capitalize w-[300px]">
                                {item.institution ? item.institution : "-"}
                              </td>
                              <td className=" px-3  capitalize w-[100px]">
                  ...
                  // <></>
                  <div className="font bold uppercase p-4 font-bold border w-[100%] h-[70vh]">
                    data not found
                  </div>
                )}
              </div>
                    ...
                    <table className="w-full">
                      <tbody>
                        <tr className="border  border-black ">
                          ...
                          <td className="border-r  border-black px-3  capitalize w-[100px] font-bold">
                            start
                          </td>
                          <td className=" px-3  capitalize w-[100px] font-bold">
                            end
                        ...
                        {work_experience.map((item) => {
                          return (
                            <tr className="border  border-black" key={item.id}>
                              <td className="border-r px-3  border-black capitalize w-[100px] ">
                              ...
                              <td className="border-r  border-black px-3  capitalize w-[100px]">
                        ...
                        {Professional_Service.map((item) => {
                          return (
                            <tr
                              ...
                              key={item.id}
                            >
                              <td className=" p-3 text-black   capitalize w-[100px] -mr-40">
            ...
            {state === 6 && (
              <div className="w-full p-3 text-black ">
                ...
                <div className="  overflow-scroll h-[70vh] p-3 text-black w-full  border rounded-md shadow-lg hover:shadow-2xl">
                  {publications ? (
                    publications[0]?.pub_pdf?.length === 0 ? (
                      <></>
                    ) : (
                      <div className="w-full flex justify-center items-center h-12">
                        <button
                          onClick={() => {
                            publications[0].pub_pdf
                              ? downloadFileURL(publications[0].pub_pdf)
                              : alert("file not exist");
                          }}
                          className="w-[200px] p-3 text-black bg-[#941B0C]  mt-3"
                        >
                          {" "}
                          Journals
                        </button>
                ...
                {phd_students ? (
                  <div className="  overflow-scroll h-[70vh] p-3 text-black border rounded-md shadow-lg hover:shadow-2xl">
                    <table className="w-full">
                      <tbody>
                        <tr className="border  border-black ">
                          <td className="border-r px-3  border-black capitalize w-[100px] font-bold text-center">
                            Candidate Name
                          </td>
                          <td className="border-r px-3 border-black capitalize w-[350px] font-bold text-center">
                            Thesis Topic
                          </td>
                          <td className="border-r px-3 border-black capitalize w-[100px] font-bold text-center">
                            Start
                          </td>
                          <td className=" px-3  capitalize w-[100px] font-bold text-center">
                            end
                          </td>
                        </tr>
                        {phd_students.map((item) => {
                          return (
                            <tr className="border  border-black" key={item.id}>
                              <td className="border-r px-3  border-black capitalize  ">
                                {item.phd_student_name
                                  ? item.phd_student_name
                                  : "-"}
                              </td>
                              <td className="border-r px-3 border-black capitalize w-[300px]">
                                {item.thesis_topic ? item.thesis_topic : "-"}
                              </td>
                              <td className="border-r px-3 border-black capitalize ">
                        ...
                        {pg_ug_projects.map((item) => {
                          return (
                            <tr className="border  border-black" key={item.id}>
                              ...
                              <td className="border-r px-3 border-black capitalize ">
                                {item.project_topic ? item.project_topic : "-"}
                              </td>
                              <td className="border-r px-3 border-black capitalize ">
                                {item.start_year ? item.start_year : "-"}
                              </td>
                  ...
                  <>
                    <div className="  overflow-scroll h-[70vh] p-3 text-black border rounded-md shadow-lg hover:shadow-2xl">
                      <table className="w-full">
                        <tbody>
                          <tr className="border  border-black ">
                            <td className="border-r p-3 text-black  border-black capitalize w-[50px] font-bold">
                              Subject Code
                            </td>
                            <td className="border-r p-3 text-black  border-black capitalize w-[350px] font-bold">
                              Subject Name
                            </td>
                            <td className="border-r p-3 text-black border-black capitalize w-[100px] font-bold">
                              Start
                            </td>
                            <td className="p-3 capitalize w-[100px] font-bold">
                              End
                            </td>
                          </tr>
                          {subjects.map((item) => {
                            return (
                              <tr
                                ...
                                key={item.id}
                              >
                                <td className="border-r p-2  border-black capitalize">
                                  {item.code ? item.code : "-"}
                                </td>
                                <td className="border-r p-2  border-black capitalize ">
                                  {item.name ? item.name : "-"}
                        ...
                        return (
                          <li key={i} className="flex">
                            ...
                            <div className="text-md">
                              ...
                              , &quot{item?.title ? item.title : ""}&quot ,
                              {item?.journal_name ? item.journal_name : ""} ,
                              {item?.citation_key ? item.citation_key : ""} ,{" "}
                              {item?.year ? item.year : ""}{" "}
                            </div>
                      ...
                      <table className="w-full">
                        <tbody>
                          <tr className="border  border-black ">
                            ...
                            <td className=" px-3  capitalize  font-bold w-[100px]">
                              end
                            </td>
                          </tr>
                          {membership.map((item) => {
                            return (
                              ...
                              >
                                ...
                                <td className="border-r px-3 border-black capitalize w-[300px]">
                                  {item.membership_society
                                    ? item.membership_society
                                    : "-"}
                                </td>
                                <td className="border-r  border-black px-3  capitalize ">
                                  {item.start ? item.start : "-"}
                                </td>
                                <td className=" px-3  capitalize ">
                                  {item.end ? item.end : "-"}
                    ...
                    <table className="w-full">
                      <tbody>
                        <tr className="border  border-black ">
                          ...
                          <td className="border-r px-3  border-black capitalize w-[150px] font-bold text-center">
                            Sponsor
                          </td>
                          <td className="border-r px-3 border-black capitalize w-[100px] font-bold text-center">
                            Amount
