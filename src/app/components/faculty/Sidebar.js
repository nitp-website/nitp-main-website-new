        ...
        <div className='block md:hidden'>
           ...
           <div className={`absolute ${active?"visible":"hidden"} bg-[#941B0C]  rounded-xl mx-3 p-3 text-sm text-[rgb(255,249,239)] z-2`}>
            <ul className='flex flex-col gap-2 border-2 p-2 hover:border-[#941B0C]'>
                ...
                {past_admin||curr_admin?<li className='flex cursor-pointer' onClick={()=>{setstate(5);setactive(!active);}}><Image src={"/ad.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover'/><span className='mt-1'>Administersative Responsibilities</span></li>:<></>}
                ...
                {conference.length!==0?<li className='flex cursor-pointer' onClick={()=>{setstate(7);setactive(!active);}}><Image src={"/conference.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover'/><span className='mt-1'>Confernces</span></li>:<></>}
