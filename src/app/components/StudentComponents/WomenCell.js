          ...
          <div className="flex flex-col">
            {state === "Home" && (
              <div className="border shadow-xl w-full h-[70vh] p-3 text-md font-semibold text-black">
                As per the directives of the Chairman UGC a Women's cell has
                been set up under a committee to ensure safe working environment
                and inspiring learning environment for the women employees and
                girl students of the Institute in order to enable them to
                discharge their academic and professional responsibilities
                efficiently. The committee constantly monitors the existing
                arrangements and suggests additional measures to be put into
                operation to ensure that the Institute is free of any kind of
                harassment.
              </div>
            )}
