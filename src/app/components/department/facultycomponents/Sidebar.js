        ...
        <div className='block md:hidden'>
           ...
           <div className={`absolute ${active?"visible":"hidden"} bg-[#941B0C]  rounded-xl mx-3 p-3 text-sm text-[rgb(255,249,239)] z-2`}>
            <ul className='flex flex-col gap-2 border-2 p-2 hover:border-[#941B0C]'>
                {resume?<li className='flex cursor-pointer ' onClick={()=>{setstate(1);setactive(!active);}}><img src={"/resume.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Resume</span></li>:<></>}
                {education?<li className='flex cursor-pointer' onClick={()=>{setstate(2);setactive(!active);}}><img src={"/qual.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Educational Qualifications</span></li>:<></>}
                {work?<li className='flex cursor-pointer' onClick={()=>{setstate(3);setactive(!active);}}><img src={"/expeience.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Teaching Experience</span></li>:<></>}
                {subjects?<li className='flex cursor-pointer' onClick={()=>{setstate(10);setactive(!active);}}><img src={"/sub.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Subjects Teaching</span></li>:<></>}
                {professional?<li className='flex cursor-pointer' onClick={()=>{setstate(4);setactive(!active);}}><img src={"/pro.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Professional Services</span></li>:<></>}
                {past_admin||curr_admin?<li className='flex cursor-pointer' onClick={()=>{setstate(5);setactive(!active);}}><img src={"/ad.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Administersative Responsibilities</span></li>:<></>}
                {publications?publications[0]?.pub_pdf?.length?<li className='flex cursor-pointer' onClick={()=>{setstate(6);setactive(!active);}}><img src={"/jou.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Journal Publications</span></li>:<></>:<></>}
                {phd_students?<li className='flex cursor-pointer' onClick={()=>{setstate(8);setactive(!active);}}><img src={"/phd.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Phd Candidates</span></li>:<></>}
                {memebership?<li className='flex cursor-pointer' onClick={()=>{setstate(12);setactive(!active);}}><img src={"/mem.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Memberships</span></li>:<></>}
                {pg_ug_projects?<li className='flex cursor-pointer' onClick={()=>{setstate(9);setactive(!active);}}><img src={"/project.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>PG/UG Projects</span></li>:<></>}
                {conference.length!==0?<li className='flex cursor-pointer' onClick={()=>{setstate(7);setactive(!active);}}><img src={"/conference.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Confernces</span></li>:<></>}
                {books.length!==0?<li className='flex cursor-pointer' onClick={()=>{setstate(11);setactive(!active);}}><img src={"/book.png"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Books/Chapters Written</span></li>:<></>}
                {article.length!==0?<li className='flex cursor-pointer' onClick={()=>{setstate(13);setactive(!active);}}><img src={"/article.jpg"} alt='blank' width={50} height={50} className='mt-1 mx-1 mr-2 w-[25px] h-[25px] brightness-110  object-cover' loading="lazy"/><span className='mt-1'>Articles</span></li>:<></>}
            </ul>
           </div>
        </div>
        {/* laptop view */}
