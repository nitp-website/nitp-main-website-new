...
const CoPiapi1 = `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/faculty?type=anmesh.me@nitp.ac.in`;
const CoPiapi2 = `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/faculty?type=gagandeep.ee@nitp.ac.in`;

const postions = [
  {
    title: "Proffesor Incharge",
    label: "PI",
...
export default function EmuAdministrationPage() {
  ...
  const memberCategories = [
    ...
    { title: "PO", members: coPiData.length ? coPiData : [] },
    {
      title: "Other Members",
      members: [
        ...
        {
          name: "Mr Harishankar Pal",
          designation: "Substation/Pump/STP/Street Light Operator",
        },
        {
  ...
  return (
    <div className="w-full min-h-screen p-4 bg-white bg-opacity-50 flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-8 items-stretch">
        {/* Member Section */}
        <div className="flex flex-col mx-auto w-full lg:w-3/4 p-4 bg-gray-200 rounded-lg shadow-lg">
